        ...
        try {
            ...
            for (const row of copy_data_csv) {
                try {
                    ...
                    const car_spawned = row_data[15].trim()
                    const ped_spawned = row_data[16].trim()
                    const ped_collide = '0'
                    const car_collide = 'False'
        ...
        try {
            ...
            for (const row of data_csv) {
                try {
                    ...
                    const ped_collide = row_data[17].trim()
                    const car_collide = row_data[18].trim()
